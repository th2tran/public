/* * jquery-win8 - A version of jQuery for Windows 8 Applications * version:	0.1 * author: appendTo, LLC * copyright: 2012 * license:	MIT (http://www.opensource.org/licenses/mit-license) * date: Sat, 03 Nov 2012 00:17:51 GMT*/
(function (e, t) {
    function _(e) {
        var t = M[e] = {};
    ...
    v.Callbacks = function (e) {
        ...
        p.setAttribute("className", "t"), a = i.createDocumentFragment(), a.appendChild(i.createTextNode("  ")), a.appendChild(i.createElement("link")), a.appendChild(i.createElement("table")), r = i.createElement("a"), r.setAttribute("href", "/a"), r.appendChild(i.createTextNode("a")), a.appendChild(r), u = i.createElement("input"), u.setAttribute("type", "checkbox"), a.appendChild(u), p.appendChild(a), n = p.getElementsByTagName("*"), r = p.getElementsByTagName("a")[0], r.style.cssText = "top:1px;float:left;opacity:.5";
    ...
    function (e, t) {
        ...
        var n, r, i, s, o, u, a, f, l, c, h = !0,
            ...
            et = K(function (e) {
                e.id = d + 0, e.appendChild(function () {
                    var e = g.createDocumentFragment(),
                        t = g.createElement("a");
                    t.setAttribute("name", d);
                    var n = g.createElement("div");
                    return n.setAttribute("name", d), e.appendChild(t), e.appendChild(n), e
        ...
        nt.matches = function (e, t) {
            ...
            K(function (e) {
                ...
                e.appendChild(function () {
                    ...
                    return e.setAttribute("test", ""), e
                }()), e.querySelectorAll("[test^='']").length && i.push("[*^$]=" + O + "*(?:\"\"|'')"), e.innerHTML = "<input type='hidden'/>", e.querySelectorAll(":enabled").length || i.push(":enabled", ":disabled")
    ...
    Nt.optgroup = Nt.option, Nt.tbody = Nt.tfoot = Nt.colgroup = Nt.caption = Nt.thead, Nt.th = Nt.td, v.support.htmlSerialize || (Nt._default = [1, "X<div>", "</div>"]), v.fn.extend({
        ...
        return n = n || i, n = !n.nodeType && n[0] || n, n = n.ownerDocument || n, e.length === 1 && typeof a == "string" && a.length < 512 && n === i && a.charAt(0) === "<" && !bt.test(a) && (v.support.checkClone || !St.test(a)) && (v.support.html5Clone || !wt.test(a)) && (o = !0, s = v.fragments[a], u = s !== t), s || (s = n.createDocumentFragment(), v.clean(e, n, s, r), o && (v.fragments[a] = u && s)), {
            ...
            clone: function (e, t, n) {
                var r, i, s, o;
                v.support.html5Clone || v.isXMLDoc(e) || !wt.test("<" + e.nodeName + ">") ? o = e.cloneNode(!0) : (v.isUnsafe && typeof MSApp == "object" ? MSApp.execUnsafeLocalFunction(function () {
                ...
                for (s = 0;
                    ...
                    if (typeof u == "string")
                        if (!gt.test(u)) u = t.createTextNode(u);
                            ...
                            y = y || lt(t), c = t.createElement("div"), y.appendChild(c), u = u.replace(dt, "<$1></$2>"), a = (vt.exec(u) || ["", ""])[1].toLowerCase(), f = Nt[a] || Nt._default, l = f[0], v.isUnsafe && typeof MSApp == "object" ? MSApp.execUnsafeLocalFunction(function () {
    ...
    function (n) {
        ...
        n.extend({
                ...
                parseXML: function (r) {
                    ...
                    try {
                        typeof Windows == "object" ? (i = new Windows.Data.Xml.Dom.XmlDocument, i.loadXml(r)) : e.DOMParser ? (s = new DOMParser, i = s.parseFromString(r, "text/xml")) : (i = new ActiveXObject("Microsoft.XMLDOM"), i.async = "false", i.loadXML(r))
                    } catch (o) {
                        i = t
                    }
                    return (!i || !i.documentElement || i.getElementsByTagName("parsererror").length) && n.error("Invalid XML: " + r), i
                }
            })
    }(v), e.jQuery = e.$ = v, typeof define == "function" && define.amd && define.amd.jQuery && define("jquery", [], function () {
        return v
    })
})(window)